...
static std::unique_ptr<LLVMContext> TheContext; // core libraries of llvm
...
Function *FunctionAST::codegen() {
    // Check if external function has been declared before
    Function *TheFunction = TheModule->getFunction(Proto->getName());

    // in case if external funciton has not been declared
    if (!TheFunction) {
